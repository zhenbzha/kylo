...
public class ProjectManagerConfig {
    ...
    public RecursiWatcherService recursiWatcherService() {
        ...
        // TODO: Temporary code to watch all user repos in ${notebooks.users.repository}.  Later, we will only
        // TODO: ... create listeners for active notebook containers.
        rws.registerListener(new UserRepoListener(projectService(), userRepo.toPath()));
