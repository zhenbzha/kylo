package com.thinkbiganalytics.projects.transforms;
...
public class ProjectSerializer {
    ...
    public static <T> T deserialize(String json, Class<T> clazz) {
        try {
            ...
            logger.error("Error de-serializing object for class {} ", clazz, e);
    ...
    public static <T> T deserialize(String json, TypeReference<T> typeReference) {
        try {
            ...
            logger.error("Error de-serializing object with TypeReference {} ", typeReference, e);
            throw new RuntimeException("error de-serializing object", e);
        }
